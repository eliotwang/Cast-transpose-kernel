...
.LBB1_8:                                ; %.preheader97
	...
	v_lshl_or_b32 v16, v1, 1, s16
	v_mad_u32_u24 v11, v10, s2, v11
	v_mad_u32_u24 v24, v1, s2, v14
	s_mul_i32 s2, s17, s6
	v_lshl_or_b32 v14, v10, 2, s14
	v_mov_b32_e32 v15, s15
	v_mul_lo_u32 v18, v16, s7
	v_mad_u64_u32 v[16:17], s[12:13], v16, s6, 0
	s_lshl_b64 s[4:5], s[4:5], 1
	v_lshl_add_u64 v[14:15], v[14:15], 1, s[10:11]
	v_add3_u32 v17, v17, v18, s2
	...
	s_waitcnt vmcnt(3)
	v_fma_mixlo_f16 v22, s3, v2, 0
	v_mov_b32_e32 v25, v22
	v_fma_mixhi_f16 v25, s3, v3, 0
	s_waitcnt vmcnt(2)
	v_fma_mixlo_f16 v26, s3, v4, 0
	v_fma_mixhi_f16 v26, s3, v5, 0
	s_waitcnt vmcnt(1)
	v_fma_mixlo_f16 v23, s3, v6, 0
	global_store_dword v[12:13], v25, off
	global_store_dword v[16:17], v26, off
	v_mov_b32_e32 v12, v23
	s_waitcnt vmcnt(2)
	v_fma_mixlo_f16 v13, s3, v8, 0
	v_fma_mixhi_f16 v22, s3, v4, 0
	v_fma_mixhi_f16 v23, s3, v8, 0
	v_fma_mixhi_f16 v12, s3, v7, 0
	v_fma_mixhi_f16 v13, s3, v9, 0
	...
	v_fma_mixlo_f16 v16, s3, v3, 0
	v_fma_mixlo_f16 v17, s3, v7, 0
	v_fma_mixhi_f16 v16, s3, v5, 0
	v_fma_mixhi_f16 v17, s3, v9, 0
	s_waitcnt lgkmcnt(0)
...
.LBB1_20:
	...
	.amdhsa_kernel _Z31cast_transpose_optimized_kernelPKfS0_P6__halfS2_S0_Pfmm
		.amdhsa_group_segment_fixed_size 2336
		.amdhsa_private_segment_fixed_size 0
...
; FloatMode: 240
; IeeeMode: 1
; LDSByteSize: 2336 bytes/workgroup (compile time only)
; SGPRBlocks: 3
; VGPRBlocks: 3
